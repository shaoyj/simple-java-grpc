...
public class MynMapUtils {
    ...
    public static Map<String, Object> jsonArrayToMapByJSONObject(JSONArray jsonArray) {
        Map<String, Object> map = new HashMap<>(jsonArray.size() * 2);
